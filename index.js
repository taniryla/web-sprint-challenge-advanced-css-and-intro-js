...
// Per Brit's Slack instruction, crossing the above out so that task 7 functions properly. But it did show up in the console log correctly before crossing out as Vincent van Gogh. 
...
// function get20s(array, key, key1) {
//   const newArray = [];
//   for (let i = 0; i < array.length; i++) {
//     const x = parseFloat(array[i][key]);
//     if (x > 1899 && x < 2000) {
//       newArray.push(array[i][key1]);
//     }
//   }
//   return newArray;
// }
...
function get20s(array) {
  const newArray = [];
  for (let i = 0; i < array.length; i++) {
    const x = parseFloat(array[i]["years"]);
    if (x > 1899 && x < 2000) {
...
function addArtist(array){
    array.push({"id": 20, "name": "Ryland Taniguchi", "years": "1978 - 2021", "genre": "web design", "nationality": "asian", "genre": "lorem ipsum", "paintings": 0});
    return array;
  }
